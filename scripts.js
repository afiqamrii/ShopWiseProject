...
function signIn(){
    ...
    let params = {
        ...
        "redirect_uri" : "https://shop-wise-project-v1.vercel.app/ShopWise-Projects/shopping.html",
        "response_type" : "token",
...
function logout() {
    ...
    .then((data) => {
        location.href = "https://shop-wise-project-v1.vercel.app/ShopWise-Projects/index.html"
    })
